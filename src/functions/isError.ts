import { TypedError, TypedErrorVariant, TypedErrorInfo } from "../classes/TypedError";
...
export function isError<V1 extends V2, V2 extends Exclude<TypedErrorVariant, V2>, R>(variant: V1 | symbol, error: R | TypedError<V2, any>): error is TypedError<V1, any>
{
